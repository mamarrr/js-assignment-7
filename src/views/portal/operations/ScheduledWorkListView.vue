...
<template>
  <main class="operation-page">
    <header class="operation-header">
      ...
      <RouterLink
        class="primary"
        :to="`/companies/${params.companySlug.value}/tickets/${params.ticketId.value}/scheduled-work/new`"
        >Create scheduled work</RouterLink
      >
    </header>
      ...
      <table v-else>
        ...
        <tbody>
          <tr v-for="item in page?.items" :key="item.scheduledWorkId">
            ...
            <td>
              <RouterLink
                :to="`/companies/${params.companySlug.value}/tickets/${params.ticketId.value}/scheduled-work/${item.scheduledWorkId}`"
                >Details</RouterLink
              >
            </td>
          </tr>
